...
<div class="space">
	...
	<table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
			...
			<tr>
				...
				<td width="*"><?php echo $form->dropDownList($model, 'scope' , $scopeOption, array('data-placeholder'=>'请选择部门', 'multiple' => 'multiple', 'style'=>'width:140px;')); ?></td>
			</tr>
			<?php endif;?>
...
$(function(){
	...
	$('#User_scope').chosen({no_results_text: "没有该部门"});
});
</script>
<?php endif;?>